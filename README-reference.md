...
- [ ] Feature 3
    - [ ] Nested Feature
-->
See the [open issues](https://github.com/EJOOSTEROP/mimosa/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/EJOOSTEROP/mimosa](https://github.com/EJOOSTEROP/mimosa)
...
[product-screenshot]: https://github.com/EJOOSTEROP/mimosa/blob/main/etc/intro_image,jpg?raw=true
[project-logo]: https://github.com/EJOOSTEROP/mimosa/blob/main/etc/logo.png?raw=true
